...
namespace ssvs
{
	...
	inline auto getFingerBit(FingerBitset& mBitset, FingerID mI) noexcept					{ return mBitset[mI]; }
	inline constexpr bool getFingerBit(const FingerBitset& mBitset, FingerID mI) noexcept	{ return mBitset[mI]; }
