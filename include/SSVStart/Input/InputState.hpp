...
namespace ssvs
{
	...
	namespace Input
	{
		class InputState
		{
			...
			public:
				inline auto getFinger(FingerID mX) noexcept			{ return getFingerBit(fingers, mX); }
				...
				inline bool getFinger(FingerID mX) const noexcept	{ return getFingerBit(fingers, mX); }
