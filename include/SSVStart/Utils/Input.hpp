...
#define SSVS_INS_KEY(mName) SSVS_KEY_PREFIX #mName
            static std::string keys[]{SSVS_INS_KEY(A), SSVS_INS_KEY(B),
                SSVS_INS_KEY(C), SSVS_INS_KEY(D), SSVS_INS_KEY(E),
                SSVS_INS_KEY(F), SSVS_INS_KEY(G), SSVS_INS_KEY(H),
                SSVS_INS_KEY(I), SSVS_INS_KEY(J), SSVS_INS_KEY(K),
                SSVS_INS_KEY(L), SSVS_INS_KEY(M), SSVS_INS_KEY(N),
                SSVS_INS_KEY(O), SSVS_INS_KEY(P), SSVS_INS_KEY(Q),
                SSVS_INS_KEY(R), SSVS_INS_KEY(S), SSVS_INS_KEY(T),
                SSVS_INS_KEY(U), SSVS_INS_KEY(V), SSVS_INS_KEY(W),
                SSVS_INS_KEY(X), SSVS_INS_KEY(Y), SSVS_INS_KEY(Z),
                ...
                SSVS_INS_KEY(Num9), SSVS_INS_KEY(Escape),
                SSVS_INS_KEY(LControl), SSVS_INS_KEY(LShift),
                SSVS_INS_KEY(LAlt), SSVS_INS_KEY(LSystem),
                SSVS_INS_KEY(RControl), SSVS_INS_KEY(RShift),
                SSVS_INS_KEY(RAlt), SSVS_INS_KEY(RSystem), SSVS_INS_KEY(Menu),
                SSVS_INS_KEY(LBracket), SSVS_INS_KEY(RBracket),
                SSVS_INS_KEY(SemiColon), SSVS_INS_KEY(Comma),
                SSVS_INS_KEY(Period), SSVS_INS_KEY(Quote), SSVS_INS_KEY(Slash),
                SSVS_INS_KEY(BackSlash), SSVS_INS_KEY(Tilde),
                SSVS_INS_KEY(Equal), SSVS_INS_KEY(Dash), SSVS_INS_KEY(Space),
                SSVS_INS_KEY(Return), SSVS_INS_KEY(BackSpace),
                ...
                SSVS_INS_KEY(Multiply), SSVS_INS_KEY(Divide),
                SSVS_INS_KEY(Left), SSVS_INS_KEY(Right), SSVS_INS_KEY(Up),
                SSVS_INS_KEY(Down), SSVS_INS_KEY(Numpad0),
                SSVS_INS_KEY(Numpad1), SSVS_INS_KEY(Numpad2),
                SSVS_INS_KEY(Numpad3), SSVS_INS_KEY(Numpad4),
                SSVS_INS_KEY(Numpad5), SSVS_INS_KEY(Numpad6),
                SSVS_INS_KEY(Numpad7), SSVS_INS_KEY(Numpad8),
                SSVS_INS_KEY(Numpad9), SSVS_INS_KEY(F1), SSVS_INS_KEY(F2),
                SSVS_INS_KEY(F3), SSVS_INS_KEY(F4), SSVS_INS_KEY(F5),
                SSVS_INS_KEY(F6), SSVS_INS_KEY(F7), SSVS_INS_KEY(F8),
...
#define SSVS_INS_BTN(mName) SSVS_BTN_PREFIX #mName
            static std::string btns[]{SSVS_INS_BTN(Left), SSVS_INS_BTN(Right),
                SSVS_INS_BTN(Middle), SSVS_INS_BTN(XButton1),
...
#define SSVS_INS_KEY(mName)                 \
    {                                       \
        SSVS_KEY_PREFIX #mName, KKey::mName \
            ...
            static std::map<std::string, KKey> keys{SSVS_INS_KEY(A),
                SSVS_INS_KEY(B), SSVS_INS_KEY(C), SSVS_INS_KEY(D),
                SSVS_INS_KEY(E), SSVS_INS_KEY(F), SSVS_INS_KEY(G),
                SSVS_INS_KEY(H), SSVS_INS_KEY(I), SSVS_INS_KEY(J),
                SSVS_INS_KEY(K), SSVS_INS_KEY(L), SSVS_INS_KEY(M),
                SSVS_INS_KEY(N), SSVS_INS_KEY(O), SSVS_INS_KEY(P),
                SSVS_INS_KEY(Q), SSVS_INS_KEY(R), SSVS_INS_KEY(S),
                SSVS_INS_KEY(T), SSVS_INS_KEY(U), SSVS_INS_KEY(V),
                SSVS_INS_KEY(W), SSVS_INS_KEY(X), SSVS_INS_KEY(Y),
...
#define SSVS_INS_KEY(mName)                 \
    {                                       \
        ...
        static std::map<std::string, KKey> keys{SSVS_INS_KEY(J),
            SSVS_INS_KEY(K), SSVS_INS_KEY(L), SSVS_INS_KEY(R), SSVS_INS_KEY(S),
    ...
    {                                       \
        SSVS_BTN_PREFIX #mName, MBtn::mName \
            ...
            static std::map<std::string, MBtn> btns{SSVS_INS_BTN(Left),
                SSVS_INS_BTN(Right), SSVS_INS_BTN(Middle),
                SSVS_INS_BTN(XButton1), SSVS_INS_BTN(XButton2)};
#undef SSVS_INS_BTN
...
#undef SSVS_BTN_PREFIX
    ...
    inline auto& add2StateInput(GameState& mGameState, const ITrigger& mOn,
        bool& mValue, TNum mTriggerID, IType mType = IType::Always, IMode mMode = IMode::Overlap)
    {
    ...
    inline auto add3StateInput(GameState& mGameState, const ITrigger& mOff,
        const ITrigger& mOn, int& mValue, TNum mTriggerID, IType mType = IType::Always,
