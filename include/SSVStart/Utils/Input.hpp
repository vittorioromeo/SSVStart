...
#define SSVS_INS_KEY(mName)                 \
    {                                       \
        ...
        SSVS_INS_KEY(Comma), SSVS_INS_KEY(Period), SSVS_INS_KEY(Quote),
        SSVS_INS_KEY(Slash), SSVS_INS_KEY(BackSlash), SSVS_INS_KEY(Tilde),
        SSVS_INS_KEY(Equal), SSVS_INS_KEY(Dash), SSVS_INS_KEY(Space),
        SSVS_INS_KEY(Return), SSVS_INS_KEY(BackSpace), SSVS_INS_KEY(Tab),
...
/// @brief Shortcut to create a simple 2-state input that operates on a boolean
/// value.
...
/// value.
/// @details The value is set to 0 when no triggers are in use, to -1 when mOff
