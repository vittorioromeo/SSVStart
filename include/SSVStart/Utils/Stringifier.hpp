...
{
    template <typename T>
    struct Stringifier<ssvs::Vec2<T>>
    {
        template <bool TFmt>
        inline static void impl(std::ostream& mStream, const ssvs::Vec2<T>& mX)
        {
    ...
    template <typename T>
    struct Stringifier<sf::Rect<T>>
    {
        template <bool TFmt>
        inline static void impl(std::ostream& mStream, const sf::Rect<T>& mX)
        {
    ...
    template <>
    struct Stringifier<sf::Color>
    {
        template <bool TFmt>
        inline static void impl(std::ostream& mStream, const sf::Color& mX)
        {
            Impl::printBold<TFmt>(mStream, "(");
            Impl::printNonBold<TFmt>(mStream, toInt(mX.r), Console::Color::Red);
            Impl::printBold<TFmt>(mStream, ", ");
            Impl::printNonBold<TFmt>(
                mStream, toInt(mX.g), Console::Color::Green);
            Impl::printBold<TFmt>(mStream, ", ");
            Impl::printNonBold<TFmt>(
                mStream, toInt(mX.b), Console::Color::Blue);
            Impl::printBold<TFmt>(mStream, ", ");
    ...
    template <>
    struct Stringifier<ssvs::KKey>
    {
        template <bool TFmt>
        inline static void impl(std::ostream& mStream, const ssvs::KKey& mX)
        {
            Impl::printNonBold<TFmt>(mStream, "(" + ssvs::getKKeyName(mX) + ")",
                Console::Color::Yellow);
        }
    };

    template <>
    struct Stringifier<ssvs::MBtn>
    {
        template <bool TFmt>
        inline static void impl(std::ostream& mStream, const ssvs::MBtn& mX)
        {
            Impl::printNonBold<TFmt>(mStream, "(" + ssvs::getMBtnName(mX) + ")",
                Console::Color::Green);
        }
    };

    template <>
    struct Stringifier<ssvs::Input::Combo>
    {
        using T = ssvs::Input::Combo;
        template <bool TFmt>
        inline static void impl(std::ostream& mStream, const T& mX)
        {
            mStream << "[";
    ...
    template <>
    struct Stringifier<ssvs::Input::Trigger>
    {
