...
template <typename T>
inline float getRight(const T& mX) noexcept
{
    return getLeft(mX) + getWidth(mX);
}
template <typename T>
inline float getBottom(const T& mX) noexcept
{
    return getTop(mX) + getHeight(mX);
}
template <typename T>
inline float getHalfWidth(const T& mX) noexcept
{
    return getWidth(mX) / 2.f;
}
template <typename T>
inline float getHalfHeight(const T& mX) noexcept
{
    return getHeight(mX) / 2.f;
}

template <typename T>
inline float getCenterX(const T& mX) noexcept
{
    return getLeft(mX) + getHalfWidth(mX);
}
template <typename T>
inline float getCenterY(const T& mX) noexcept
{
    return getTop(mX) + getHalfHeight(mX);
}

template <typename T>
inline sf::Vec2f getSize(const T& mX) noexcept
{
    return {getWidth(mX), getHeight(mX)};
}
template <typename T>
inline sf::Vec2f getHalfSize(const T& mX) noexcept
{
    return {getHalfWidth(mX), getHalfHeight(mX)};
}

template <typename T>
inline sf::Vec2f getNW(const T& mX) noexcept
{
    return {getLeft(mX), getTop(mX)};
}
template <typename T>
inline sf::Vec2f getNE(const T& mX) noexcept
{
    return {getRight(mX), getTop(mX)};
}
template <typename T>
inline sf::Vec2f getSW(const T& mX) noexcept
{
    return {getLeft(mX), getBottom(mX)};
}
template <typename T>
inline sf::Vec2f getSE(const T& mX) noexcept
{
    return {getRight(mX), getBottom(mX)};
}

template <typename T>
inline sf::Vec2f getCenter(const T& mX) noexcept
{
    return getNW(mX) + getHalfSize(mX);
}

template <typename T>
inline sf::Vec2f getCenterN(const T& mX) noexcept
{
    return {getCenterX(mX), getTop(mX)};
}
template <typename T>
inline sf::Vec2f getCenterE(const T& mX) noexcept
{
    return {getRight(mX), getCenterY(mX)};
}
template <typename T>
inline sf::Vec2f getCenterS(const T& mX) noexcept
{
    return {getCenterX(mX), getBottom(mX)};
}
template <typename T>
inline sf::Vec2f getCenterW(const T& mX) noexcept
{
...
template <typename T>
inline float getGlobalLeft(const T& mX) noexcept
{
    return Impl::getLeft(mX.getGlobalBounds());
}

/// @brief Returns global top position of a drawable element.
template <typename T>
inline float getGlobalTop(const T& mX) noexcept
{
    return Impl::getTop(mX.getGlobalBounds());
}

/// @brief Returns global width of a drawable element.
template <typename T>
inline float getGlobalWidth(const T& mX) noexcept
{
    return Impl::getWidth(mX.getGlobalBounds());
}

/// @brief Returns global height of a drawable element.
template <typename T>
inline float getGlobalHeight(const T& mX) noexcept
{
    return Impl::getHeight(mX.getGlobalBounds());
}

/// @brief Returns global right position of a drawable element.
template <typename T>
inline float getGlobalRight(const T& mX) noexcept
{
    return Impl::getRight(mX.getGlobalBounds());
}

/// @brief Returns global bottom position of a drawable element.
template <typename T>
inline float getGlobalBottom(const T& mX) noexcept
{
    return Impl::getBottom(mX.getGlobalBounds());
}

/// @brief Returns global half width of a drawable element.
template <typename T>
inline float getGlobalHalfWidth(const T& mX) noexcept
{
    return Impl::getHalfWidth(mX.getGlobalBounds());
}

/// @brief Returns global half height of a drawable element.
template <typename T>
inline float getGlobalHalfHeight(const T& mX) noexcept
{
    return Impl::getHalfHeight(mX.getGlobalBounds());
}

/// @brief Returns global center X of a drawable element.
template <typename T>
inline float getGlobalCenterX(const T& mX) noexcept
{
    return Impl::getCenterX(mX.getGlobalBounds());
}

/// @brief Returns global center X of a drawable element.
template <typename T>
inline float getGlobalCenterY(const T& mX) noexcept
{
    return Impl::getCenterY(mX.getGlobalBounds());
}

/// @brief Returns global size of a drawable element.
template <typename T>
inline sf::Vec2f getGlobalSize(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalHalfSize(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalNW(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalNE(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalSW(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalSE(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalCenter(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalCenterN(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalCenterE(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalCenterS(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getGlobalCenterW(const T& mX) noexcept
{
...
template <typename T>
inline float getLocalLeft(const T& mX) noexcept
{
    return Impl::getLeft(mX.getLocalBounds());
}

/// @brief Returns local top position of a drawable element.
template <typename T>
inline float getLocalTop(const T& mX) noexcept
{
    return Impl::getTop(mX.getLocalBounds());
}

/// @brief Returns local width of a drawable element.
template <typename T>
inline float getLocalWidth(const T& mX) noexcept
{
    return Impl::getWidth(mX.getLocalBounds());
}

/// @brief Returns local height of a drawable element.
template <typename T>
inline float getLocalHeight(const T& mX) noexcept
{
    return Impl::getHeight(mX.getLocalBounds());
}

/// @brief Returns local right position of a drawable element.
template <typename T>
inline float getLocalRight(const T& mX) noexcept
{
    return Impl::getRight(mX.getLocalBounds());
}

/// @brief Returns local bottom position of a drawable element.
template <typename T>
inline float getLocalBottom(const T& mX) noexcept
{
    return Impl::getBottom(mX.getLocalBounds());
}

/// @brief Returns local half width of a drawable element.
template <typename T>
inline float getLocalHalfWidth(const T& mX) noexcept
{
    return Impl::getHalfWidth(mX.getLocalBounds());
}

/// @brief Returns local half height of a drawable element.
template <typename T>
inline float getLocalHalfHeight(const T& mX) noexcept
{
    return Impl::getHalfHeight(mX.getLocalBounds());
}

/// @brief Returns local center X of a drawable element.
template <typename T>
inline float getLocalCenterX(const T& mX) noexcept
{
    return Impl::getCenterX(mX.getLocalBounds());
}

/// @brief Returns local center X of a drawable element.
template <typename T>
inline float getLocalCenterY(const T& mX) noexcept
{
    return Impl::getCenterY(mX.getLocalBounds());
}

/// @brief Returns local size of a drawable element.
template <typename T>
inline sf::Vec2f getLocalSize(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalHalfSize(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalNW(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalNE(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalSW(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalSE(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalCenter(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalCenterN(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalCenterE(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalCenterS(const T& mX) noexcept
{
...
template <typename T>
inline sf::Vec2f getLocalCenterW(const T& mX) noexcept
{
...
/// `sf::Vec2f`.
template <typename T>
inline void setOrigin(T& mX, sf::Vec2f (*mFn)(const T&)) noexcept
{
    mX.setOrigin(mFn(mX));
}
...
{
    float r(((mHex >> 16) & 255)), g(((mHex >> 8) & 255)),
        b(((mHex >> 0) & 255));
