...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch)./include/ $(IncludeSwitch)../SSVUtils/include/ $(IncludeSwitch)../SFML/include/ 
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)../SSVUtils/lib/libSSVUtils-s $(LibrarySwitch)../SFML/build2/lib/libsfml-system $(LibrarySwitch)../SFML/build2/lib/libsfml-window $(LibrarySwitch)../SFML/build2/lib/libsfml-audio $(LibrarySwitch)../SFML/build2/lib/libsfml-graphics $(LibrarySwitch)../SFML/build2/lib/libsfml-network 
ArLibs                 :=  "../SSVUtils/lib/libSSVUtils-s.a" "../SFML/build2/lib/libsfml-system.a" "../SFML/build2/lib/libsfml-window.a" "../SFML/build2/lib/libsfml-audio.a" "../SFML/build2/lib/libsfml-graphics.a" "../SFML/build2/lib/libsfml-network.a" 
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)../SSVUtils/lib/ $(LibraryPathSwitch)../SFML/build2/lib/ 
